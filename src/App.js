      ...
      <header className="app-header">
        ...
        <div className="video-title-container">
          {videoTitle === "No video playing" ? (
            ...
            <marquee className="video-title" direction="left" scrollamount="4">
              {videoTitle}
            </marquee>
          )}
          {videoSource === null ? (
            <img src={cassettePng} className="cassette" alt="cassette-icon" />
          ) : (
            <img src={cassetteGif} className="cassette" alt="cassette-icon" />
          )}
        </div>
      </header>
      <main>
